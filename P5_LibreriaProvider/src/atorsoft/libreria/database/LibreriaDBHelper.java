...
public class LibreriaDBHelper {
	...
	public LibreriaDBHelper(Context contexto) {
		mLibreriaOpenHelper = new LibreriaOpenHelper(contexto);
	}
	...
	// Consultar libros
	public Cursor queryLibros(String[] columns, String selection,
			String[] selectionArgs, String groupBy, String having,
			String orderBy) {
		if (mLibreriaDB == null) {
			mLibreriaDB = mLibreriaOpenHelper.getReadableDatabase();
		}
		return mLibreriaDB.query(DATABASE_TABLE, columns, selection,
				selectionArgs, groupBy, having, orderBy);
	}

	// Obtener todos los libros
	public Cursor getLibros() {
		return queryLibros(columnas, null, null, null, null, TITULO);
	}

	// Obtener libro
	public Cursor getLibro(long idLibro) {
		return queryLibros(columnas, _ID + "=?",
